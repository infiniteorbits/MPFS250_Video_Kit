//////////////////////////////////////////////////////////////////////
// Created by SmartDesign Wed May 22 10:32:16 2024
...
//--------------------------------------------------------------------
input        ARST_N;
input  [3:0] DELAY_LINE_DIRECTION;
input  [3:0] DELAY_LINE_LOAD;
input  [3:0] DELAY_LINE_MOVE;
input  [3:0] EYE_MONITOR_CLEAR_FLAGS;
...
output [3:0] DELAY_LINE_OUT_OF_RANGE;
output [3:0] EYE_MONITOR_EARLY;
output [3:0] EYE_MONITOR_LATE;
output       L0_LP_DATA;
output       L0_LP_DATA_N;
...
wire   [2:2] DELAY_LINE_DIRECTION_slice_2;
wire   [3:3] DELAY_LINE_DIRECTION_slice_3;
wire   [0:0] DELAY_LINE_LOAD_slice_0;
wire   [1:1] DELAY_LINE_LOAD_slice_1;
wire   [2:2] DELAY_LINE_LOAD_slice_2;
wire   [3:3] DELAY_LINE_LOAD_slice_3;
wire   [0:0] DELAY_LINE_MOVE_slice_0;
wire   [1:1] DELAY_LINE_MOVE_slice_1;
wire   [2:2] DELAY_LINE_MOVE_slice_2;
wire   [3:3] DELAY_LINE_MOVE_slice_3;
...
wire   [2:2] EYE_MONITOR_CLEAR_FLAGS_slice_2;
wire   [3:3] EYE_MONITOR_CLEAR_FLAGS_slice_3;
...
wire   [2:2] EYE_MONITOR_EARLY_1_net_0;
wire   [3:3] EYE_MONITOR_EARLY_2_net_0;
wire   [0:0] EYE_MONITOR_LATE_net_1;
wire   [1:1] EYE_MONITOR_LATE_0_net_0;
wire   [2:2] EYE_MONITOR_LATE_1_net_0;
wire   [3:3] EYE_MONITOR_LATE_2_net_0;
wire   [0:0] DELAY_LINE_OUT_OF_RANGE_net_1;
wire   [1:1] DELAY_LINE_OUT_OF_RANGE_0_net_0;
wire   [2:2] DELAY_LINE_OUT_OF_RANGE_1_net_0;
wire   [3:3] DELAY_LINE_OUT_OF_RANGE_2_net_0;
wire         CLK_TRAIN_DONE_net_1;
wire         CLK_TRAIN_ERROR_net_1;
wire   [1:0] HS_IO_CLK_net_0;
wire   [3:0] EYE_MONITOR_CLEAR_FLAGS;
wire   [3:0] DELAY_LINE_MOVE;
wire   [3:0] DELAY_LINE_DIRECTION;
wire   [3:0] DELAY_LINE_LOAD;
//--------------------------------------------------------------------
// TiedOff Nets
//--------------------------------------------------------------------
...
wire   [3:0] PAD_const_net_0;
wire   [3:0] PAD_N_const_net_0;
...
assign PAD_const_net_0                = 4'h0;
assign PAD_N_const_net_0              = 4'h0;
...
assign EYE_MONITOR_EARLY_1_net_0[2]       = EYE_MONITOR_EARLY_1;
assign EYE_MONITOR_EARLY[2:2]             = EYE_MONITOR_EARLY_1_net_0[2];
assign EYE_MONITOR_EARLY_2_net_0[3]       = EYE_MONITOR_EARLY_2;
assign EYE_MONITOR_EARLY[3:3]             = EYE_MONITOR_EARLY_2_net_0[3];
...
assign EYE_MONITOR_LATE_1_net_0[2]        = EYE_MONITOR_LATE_1;
assign EYE_MONITOR_LATE[2:2]              = EYE_MONITOR_LATE_1_net_0[2];
assign EYE_MONITOR_LATE_2_net_0[3]        = EYE_MONITOR_LATE_2;
assign EYE_MONITOR_LATE[3:3]              = EYE_MONITOR_LATE_2_net_0[3];
...
assign DELAY_LINE_OUT_OF_RANGE_1_net_0[2] = DELAY_LINE_OUT_OF_RANGE_1;
assign DELAY_LINE_OUT_OF_RANGE[2:2]       = DELAY_LINE_OUT_OF_RANGE_1_net_0[2];
assign DELAY_LINE_OUT_OF_RANGE_2_net_0[3] = DELAY_LINE_OUT_OF_RANGE_2;
assign DELAY_LINE_OUT_OF_RANGE[3:3]       = DELAY_LINE_OUT_OF_RANGE_2_net_0[3];
...
assign DELAY_LINE_DIRECTION_slice_2[2]    = DELAY_LINE_DIRECTION[2:2];
assign DELAY_LINE_DIRECTION_slice_3[3]    = DELAY_LINE_DIRECTION[3:3];
assign DELAY_LINE_LOAD_slice_0[0]         = DELAY_LINE_LOAD[0:0];
assign DELAY_LINE_LOAD_slice_1[1]         = DELAY_LINE_LOAD[1:1];
assign DELAY_LINE_LOAD_slice_2[2]         = DELAY_LINE_LOAD[2:2];
assign DELAY_LINE_LOAD_slice_3[3]         = DELAY_LINE_LOAD[3:3];
assign DELAY_LINE_MOVE_slice_0[0]         = DELAY_LINE_MOVE[0:0];
assign DELAY_LINE_MOVE_slice_1[1]         = DELAY_LINE_MOVE[1:1];
assign DELAY_LINE_MOVE_slice_2[2]         = DELAY_LINE_MOVE[2:2];
assign DELAY_LINE_MOVE_slice_3[3]         = DELAY_LINE_MOVE[3:3];
...
assign EYE_MONITOR_CLEAR_FLAGS_slice_2[2] = EYE_MONITOR_CLEAR_FLAGS[2:2];
assign EYE_MONITOR_CLEAR_FLAGS_slice_3[3] = EYE_MONITOR_CLEAR_FLAGS[3:3];
//--------------------------------------------------------------------
...
PF_IOD_GENERIC_RX_C0_TR COREBCLKSCLKALIGN_0(
        // Inputs
        .SCLK                    ( RX_CLK_G_net_0 ),
        .RESETN                  ( ARST_N ),
...
//--------PF_IOD_GENERIC_RX_C0_PF_CLK_DIV_FIFO_PF_CLK_DIV_DELAY   -   Actel:SgCore:PF_CLK_DIV_DELAY:1.1.101
PF_IOD_GENERIC_RX_C0_PF_CLK_DIV_FIFO_PF_CLK_DIV_DELAY PF_CLK_DIV_FIFO(
        // Inputs
...
//--------PF_IOD_GENERIC_RX_C0_PF_CLK_DIV_RXCLK_PF_CLK_DIV_DELAY   -   Actel:SgCore:PF_CLK_DIV_DELAY:1.1.101
PF_IOD_GENERIC_RX_C0_PF_CLK_DIV_RXCLK_PF_CLK_DIV_DELAY PF_CLK_DIV_RXCLK(
        // Inputs
        .CLK_IN            ( HS_IO_CLK_CASCADED_Y ),
        // Outputs
...
//--------PF_IOD_GENERIC_RX_C0_PF_IOD_CLK_TRAINING_PF_IOD   -   Actel:SgCore:PF_IOD:1.0.218
PF_IOD_GENERIC_RX_C0_PF_IOD_CLK_TRAINING_PF_IOD PF_IOD_CLK_TRAINING(
        // Inputs
...
//--------PF_IOD_GENERIC_RX_C0_PF_IOD_RX_PF_IOD   -   Actel:SgCore:PF_IOD:1.0.218
PF_IOD_GENERIC_RX_C0_PF_IOD_RX_PF_IOD PF_IOD_RX(
        // Inputs
        .ARST_N                    ( PF_LANECTRL_0_ARST_N ),
        .RX_SYNC_RST               ( PF_LANECTRL_0_RX_SYNC_RST ),
        .TX_SYNC_RST               ( PF_LANECTRL_0_TX_SYNC_RST ),
        ...
        .EYE_MONITOR_CLEAR_FLAGS_2 ( EYE_MONITOR_CLEAR_FLAGS_slice_2 ),
        .EYE_MONITOR_CLEAR_FLAGS_3 ( EYE_MONITOR_CLEAR_FLAGS_slice_3 ),
        .DELAY_LINE_MOVE_0         ( DELAY_LINE_MOVE_slice_0 ),
        .DELAY_LINE_MOVE_1         ( DELAY_LINE_MOVE_slice_1 ),
        .DELAY_LINE_MOVE_2         ( DELAY_LINE_MOVE_slice_2 ),
        .DELAY_LINE_MOVE_3         ( DELAY_LINE_MOVE_slice_3 ),
        .DELAY_LINE_DIRECTION_0    ( DELAY_LINE_DIRECTION_slice_0 ),
        .DELAY_LINE_DIRECTION_1    ( DELAY_LINE_DIRECTION_slice_1 ),
        .DELAY_LINE_DIRECTION_2    ( DELAY_LINE_DIRECTION_slice_2 ),
        .DELAY_LINE_DIRECTION_3    ( DELAY_LINE_DIRECTION_slice_3 ),
        .DELAY_LINE_LOAD_0         ( DELAY_LINE_LOAD_slice_0 ),
        .DELAY_LINE_LOAD_1         ( DELAY_LINE_LOAD_slice_1 ),
        .DELAY_LINE_LOAD_2         ( DELAY_LINE_LOAD_slice_2 ),
        .DELAY_LINE_LOAD_3         ( DELAY_LINE_LOAD_slice_3 ),
        .FAB_CLK                   ( RX_CLK_G_net_0 ),
        .PAD_I                     ( RXD ),
        .PAD_I_N                   ( RXD_N ),
        .HS_SEL_0                  ( HS_SEL ),
        ...
        .DELAY_LINE_OUT_OF_RANGE_2 ( DELAY_LINE_OUT_OF_RANGE_1 ),
        .DELAY_LINE_OUT_OF_RANGE_3 ( DELAY_LINE_OUT_OF_RANGE_2 ),
        .EYE_MONITOR_EARLY_0       ( EYE_MONITOR_EARLY_net_0 ),
        .EYE_MONITOR_EARLY_1       ( EYE_MONITOR_EARLY_0 ),
        .EYE_MONITOR_EARLY_2       ( EYE_MONITOR_EARLY_1 ),
        .EYE_MONITOR_EARLY_3       ( EYE_MONITOR_EARLY_2 ),
        .EYE_MONITOR_LATE_0        ( EYE_MONITOR_LATE_net_0 ),
        .EYE_MONITOR_LATE_1        ( EYE_MONITOR_LATE_0 ),
        .EYE_MONITOR_LATE_2        ( EYE_MONITOR_LATE_1 ),
        .EYE_MONITOR_LATE_3        ( EYE_MONITOR_LATE_2 ),
        .RX_DATA_0                 ( L0_RXD_DATA_net_0 ),
        .RX_DATA_1                 ( L1_RXD_DATA_net_0 ),
        .RX_DATA_2                 ( L2_RXD_DATA_net_0 ),
        .RX_DATA_3                 ( L3_RXD_DATA_net_0 ),
        .RX_BYPASS_DATA_0          ( L0_LP_DATA_net_0 ),
        .RX_BYPASS_DATA_1          ( L1_LP_DATA_net_0 ),
        .RX_BYPASS_DATA_2          ( L2_LP_DATA_net_0 ),
        .RX_BYPASS_DATA_3          ( L3_LP_DATA_net_0 ),
        .RX_BYPASS_DATA_N_0        ( L0_LP_DATA_N_net_0 ),
        .RX_BYPASS_DATA_N_1        ( L1_LP_DATA_N_net_0 ),
        .RX_BYPASS_DATA_N_2        ( L2_LP_DATA_N_net_0 ),
        .RX_BYPASS_DATA_N_3        ( L3_LP_DATA_N_net_0 ) 
        );

//--------PF_IOD_GENERIC_RX_C0_PF_LANECTRL_0_PF_LANECTRL   -   Actel:SgCore:PF_LANECTRL:2.0.102
PF_IOD_GENERIC_RX_C0_PF_LANECTRL_0_PF_LANECTRL PF_LANECTRL_0(
        // Inputs
